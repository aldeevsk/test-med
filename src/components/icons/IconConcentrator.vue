<template>
    <svg class="icon icon-concentrator" viewBox="0 0 24 24" id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg">
        ...
        <path class="cls-1" d="M6.89,10.76c5-2.17,5.31,1.9,10.42.41"/><line class="cls-1" x1="7.23" y1="18.68" x2="9.14" y2="18.68"/>
